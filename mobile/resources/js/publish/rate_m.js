...
// $('[data-rate="date01"]').text(rateInfo.date01); //yyyy년 mm월
// $('[data-rate="date02"]').text(rateInfo.date02); //yyyy.mm.
// $('[data-rate="date03"]').text(rateInfo.date03); //yyyy년 mm월
...
// $('[data-rate="rate06"]').text(rateInfo.rate06); //에듀케어
// $('[data-rate="rate07"]').text(rateInfo.rate06); //저축
// $('[data-rate="rate09"]').text(rateInfo.rate09); //평균공시이율
// $('[data-rate="rate10"]').text(rateInfo.rate09); //연금/연금저축 평균공시이율
...
// 	rateInfo.date02 = year + '.' + month;
// 	rateInfo.date03 = year + '년 ' + parseInt(month) + '월';
...
// 	rateInfo.rate06 = F02 + '%'; //에듀케어
// 	rateInfo.rate07 = F02 + '%'; //저축
// 	rateInfo.rate09 = H01 + '%'; //평균공시이율
