								...
								if (((this.defining = !0), this.depCount < 1 && !this.defined)) {
									if (isFunction(o)) {
										...
										if (
											(this.map.isDefine &&
												void 0 === n &&
												((t = this.module) ? (n = t.exports) : this.usingExports && (n = this.exports)),
											e)
										)
											return (
			...
			(q = {
						...
						mixin(o, {
							...
							toUrl: function (e) {
								var r,
									...
									a = '.' === o || '..' === o;
								return (
									-1 !== n && (!a || n > 1) && ((r = e.substring(n, e.length)), (e = e.substring(0, n))),
				...
				nameToUrl: function (e, t, i) {
					...
					if (req.jsExtRegExp.test(e)) s = e + (t || '');
						...
						(s = n.join('/')),
							(s =
								('/' === (s += t || (/^data\:|^blob\:|\?/.test(s) || i ? '' : '.js')).charAt(0) || s.match(/^[\w\+\.\-]+:/)
									? ''
									: y.baseUrl) + s);
					}
