		...
		h =
			((n = d.createElement('div')),
			{
				touch:
					...
					!!('ontouchstart' in o || (o.DocumentTouch && d instanceof o.DocumentTouch)),
			...
			if ((n.originalEvent && (n = n.originalEvent), !i.isTouchEvent || 'mousemove' !== n.type)) {
				...
				if (!this.allowTouchMove)
					return (
						(this.allowClick = !1),
						void (
							i.isTouched && (l.extend(a, { startX: o, startY: h, currentX: o, currentY: h }), (i.touchStartTime = l.now()))
						)
					);
							...
							if (
								...
								f > 0 && i.currentTranslate > this.minTranslate()
									? ((v = !1),
									  s.resistance &&
											(i.currentTranslate =
												this.minTranslate() - 1 + Math.pow(-this.minTranslate() + i.startTranslate + f, m)))
									: f < 0 &&
									  i.currentTranslate < this.maxTranslate() &&
									  ((v = !1),
									  s.resistance &&
											(i.currentTranslate =
												this.maxTranslate() + 1 - Math.pow(this.maxTranslate() - i.startTranslate - f, m))),
			...
			setTranslate: function () {
				for (var e = this.slides, i = 0; i < e.length; i += 1) {
					...
					if (
						...
						0 === d.length &&
							((d = t('<div class="swiper-slide-shadow-' + (this.isHorizontal() ? 'left' : 'top') + '"></div>')),
							s.append(d)),
							0 === h.length &&
